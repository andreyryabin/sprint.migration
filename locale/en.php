...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_OrmTable_Info"         => "Creates a table if it does not exist and adds missing fields. Existing fields are not changed. Reapplying the migration is not an error.",
        ...
        "BUILDER_OrmFieldDelete_Info"   => "Deletes selected table fields. Missing field is not an error. After applying this migration it cannot be rolled back automatically.",
        "BUILDER_OrmFieldDelete_Fields" => "Fields to delete",
        "BUILDER_OrmTableDelete"        => "Delete ORM table",
        "BUILDER_OrmTableDelete_Info"   => "Deletes selected table. Missing table is not an error. After applying this migration it cannot be rolled back automatically.",
        "ORM_FIELD_NAME"                => "Name",
        "ORM_FIELD_TYPE"                => "Type",
