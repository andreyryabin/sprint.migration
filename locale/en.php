...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_IblockExport_PropertyIds"           => "Select properties",
        ...
        "BUILDER_IblockElementsExport1"         => "Transfer information block elements",
        "BUILDER_IblockElementsExport2"         => "Transfer elements with fields and properties\nTransfer images, files and lists",
        "BUILDER_IblockElementsExport_IblockId" => "Select information block",

        "BUILDER_IblockCategoryExport1"         => "Transfer information block categories",
        "BUILDER_IblockCategoryExport2"         => "Transfer information block categories without images",
        "BUILDER_IblockCategoryExport_IblockId" => "Select information block",

        "BUILDER_HlblockElementsExport1"          => "Transfer highload block elements",
        "BUILDER_HlblockElementsExport2"          => "Transfer highload block elements\nTransfer images, files and lists",
        ...
        "ERR_HLBLOCK_NOT_FOUND"           => "Highload block not found",
        ...
        "ERR_IB_CODE_NOT_FOUND"           => "Information block code not found",
        "ERR_IB_SECTION_NAME_NOT_FOUND"   => "Section name not found",
        "ERR_IB_NOT_FOUND"                => "Information block not found",
        "ERR_IB_TYPE_NOT_FOUND"           => "Information block type not found",
