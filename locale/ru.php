...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_IblockElementsExport_What"                 => "Настройки переноса",
        "BUILDER_IblockElementsExport_WhatUpdateExists"     => "Обновить существующие элементы (поиск по символьному коду)",
        "BUILDER_IblockElementsExport_WhatIblockFields"     => "Выбрать поля инфоблока",
        "BUILDER_IblockElementsExport_WhatIblockProperties" => "Выбрать свойства инфоблока",
