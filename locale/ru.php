...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_IblockElementsExport_All"                  => "Выбрать все",
        "BUILDER_IblockElementsExport_None"                 => "Не выбирать ничего",
        "BUILDER_IblockElementsExport_Some"                 => "Выбрать несколько",
        "BUILDER_IblockElementsExport_NotUpdate"            => "Простое добавление элементов",
        "BUILDER_IblockElementsExport_UpdateByCode"         => "Обновить элементы с такими же CODE",
        "BUILDER_IblockElementsExport_UpdateByXmlId"        => "Обновить элементы с такими же XML_ID",
