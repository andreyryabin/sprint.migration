...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_OrmTable_Info"         => "Создает таблицу, если ее нет, и добавляет отсутствующие поля. Существующие поля не изменяются. Повторное применение миграции не вызывает ошибку.",
        ...
        "BUILDER_OrmFieldDelete_Info"   => "Удаляет выбранные поля таблицы. Отсутствие поля не считается ошибкой. После применения миграцию нельзя будет отменить: удаленные поля не восстанавливаются автоматически.",
        "BUILDER_OrmFieldDelete_Fields" => "Поля для удаления",
        "BUILDER_OrmTableDelete"        => "Удалить ORM-таблицу",
        "BUILDER_OrmTableDelete_Info"   => "Удаляет выбранную таблицу. Отсутствие таблицы не считается ошибкой. После применения миграцию нельзя будет отменить: удаленная таблица не восстанавливается автоматически.",
