...
Переключить конфиг можно в админке нажав кнопку "переключить" напротив нужного конфига.

В консоли надо добавлять параметр --config={NAME} для выполнения команд в рамках этого конфига, 
 например php migrate.php list --config=release2016
