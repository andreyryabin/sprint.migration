...
**stop_on_errors** - Останавливать выполнение миграций при появлении ошибок, варианты значений: yes|no, по умолчанию no (не останавливать)

**show_other_solutions** - Показывать другие решения разработчика: yes|no, по умолчанию yes (показывать)
